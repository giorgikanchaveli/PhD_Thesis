...
\end{proposition}
\begin{proof}
    Denote by $\tilde{\nu}^{*,2}_{S}$ the L\'evy intensity of the scaled Gamma posterior; its derivation can be found in the proof of Lemma~12 in \cite{catalano2023merging}, and it has the following form:
    \[
...
\end{theorem}
\begin{proof}
    First, note that the $\wbl$ bound follows from Theorem~6 of \cite{catalano2023merging}.
