...
Since we work with distances between random measures, the key step is to quantify the distance between posterior distributions. To this end, we consider two priors given by completely random measures, derive the corresponding posterior distributions, and then compare them. Due to the identifiability issue discussed in Subsection \ref{subsection:normalization_identifiability}, we compute distances between scaled versions of these posterior distributions.
