...
\subsection{Distances on $\probprobx$}
...
\subsection{Distance for Completely Random Measures}
...
\[
\wad(\law(\tilde{\nu}^1), \law(\tilde{\nu}^2)) = \inf_{\pi \in \Gamma(\law(\nu^1), \law(\nu^2))} \E_{(v^1,v^2)\sim\pi}\left[\ad(v^1,v^2) \right]. 
\]
