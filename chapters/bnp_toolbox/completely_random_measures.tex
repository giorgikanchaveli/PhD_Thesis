...
We denote by $\mbx$ the space of finite, and by $\mx$ the space of locally finite measures. We endow $\mbx$ with the topology of weak convergence. Since $\X$ is Polish, the space $\mbx$ is also Polish. We equip $\mbx$ with its Borel $\sigma$-algebra.
