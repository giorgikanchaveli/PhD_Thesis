...
\]
for almost every infinite size hierarchical samples from $Q^1$ and $Q^2$.
...
\]
As $T$ is absolutely continuous, $\mathbb{P}(T - q(\theta) = 0) = 0$. Therefore, by Portmanteau theorem
\[
